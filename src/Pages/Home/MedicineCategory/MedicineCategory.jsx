...
const MedicineCategory = () => {
  ...
  return (
    <div className="mt-20">
      <Header title={' Find the Medicine You Need'} description={'  Discover an extensive collection of premium medicines designed to support your health and wellness.From daily essentials to specialized care, find everything you need in one place.'}></Header>
